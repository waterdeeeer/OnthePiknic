      ...
      >
        <Container flex={1} alignItems="center" display="flex">
          <Image
            width={20}
            height={20}
            backgroundImage={`url(${IMAGE_BASE_URL}/icons/magnify.png)`}
          />
          <Input
        ...
        >
          <Image
            width={30}
            height={30}
            backgroundImage={`url(${IMAGE_BASE_URL}/icons/user.png)`}
          />
          <Image
            width={30}
            height={30}
            backgroundImage={`url(${IMAGE_BASE_URL}/icons/cart.png)`}
          />
        </Container>
      </Container>
      <NavBar />
