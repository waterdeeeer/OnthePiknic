...
const getAllProducts = (products: Product[]): DB_ACTION<Product[]> => {
	return {
		type: DB_ACTION_TYPE.GET_ALL_PRODUCTS,
		payload: products,
	};
};
...
export const getAllProductsAsync = (): AsyncThunkAction => async (dispatch) => {
